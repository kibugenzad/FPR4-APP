...
export default function Page() {
  ...
  const { province } = useLocalSearchParams<any>();
  const [selected, setSelected] = useState();
  const [data, setData] = useState(Districts(province));
  ...
  if (!province)
    return (
      <Empty message="Province not found, go back and choose province first and try again" />
    );
  return (
    <>
      {renderSearch()}
