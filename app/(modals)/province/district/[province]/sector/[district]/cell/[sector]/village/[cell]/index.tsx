...
export default function Page() {
  ...
  const { province, district, sector, cell } = useLocalSearchParams<any>();
  const [selected, setSelected] = useState();
  const [data, setData] = useState(Villages(province, district, sector, cell));
  ...
  if (!province || !district || !sector || !cell)
    return (
      <Empty message="Province or district or sector or cell not found, go back and choose province and district and sector first and try again" />
    );
